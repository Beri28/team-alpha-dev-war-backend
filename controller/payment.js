...
// const headers =  {
//         apiuser: 'ad7aff47-0818-464d-b83f-c282d31e45d1',
//         apikey: 'FAK_TEST_7696d5fbf6aceb1ed716'
//     }
...
const headers =  {
    ...
    export function initiatePay(data){
        return new Promise(async function(resolve){
            try {
                ...
                if(response.data && response.data.statusCode) response.data.statusCode = response.status
    ...
    */
    export function paymentStatus(transId){
        return new Promise(async function(resolve){
            try {
    ...
    */
    export function expirePay(transId){
        return new Promise(async function(resolve){
            try {
                if(!transId || typeof transId !== 'string')
                    resolve(error('invalid type, string expected', 400))
    ...
    */
    export function userTrans(userId){
        return new Promise(async function(resolve){
            try {
